    ...
    return (
        <section className="flex flex-col justify-center items-center h-screen bg-primary">
            <div className='flex flex-col items-center justify-center w-80'>
                <h2 className="font-bold text-3xl text-center text-white mb-2">User Login</h2>
                <p className='text-center text-white'>Welcome! Enter your details to login into your account</p>
                ...
                <form className="mt-4 flex flex-col gap-6 w-full mb-10">
                    ...
                    <input className='text-white bg-white/30 rounded-xl w-fit m-auto px-8 py-2 cursor-pointer hover:bg-white hover:text-primary hover:font-semibold' type="submit" value="Login"/>
                </form>
                <p className='text-white'>Don’t you have an account? <a className='font-bold underline decoration-2' href="#">REGISTER</a></p>
            </div>
        </section>
    )
}
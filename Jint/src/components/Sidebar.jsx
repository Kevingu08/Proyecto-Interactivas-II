                        ...
                        <div className="cont-notifications shadow ">
                            <nav className="grid justify-center">
                                <div className="grid grid-cols-2 gap-36">
                                    <h1 className="font-bold text-2xl p-2 mt-4">
                                        Notifications
                                    </h1>
                                    <div
                                ...
                                <a
                                    href="#"
                                    className="shadow border-separate h-36 p-2 bg-white"
                                >
                                    <div className="grid grid-cols-2 gap-16">
                                        <strong className="font-bold" href="#">
                                            Notification
                                        </strong>
                                    ...
                                    <p className="mt-3 max-w-44">
                                        Description of the task Description of
                                        the task Description of the task
                                    </p>
                                </a>
                                <a
                                    href="#"
                                    className="shadow h-36 p-2 bg-white"
                                >
                                    <div className="grid grid-cols-2 gap-16">
                                        <strong className="font-bold" href="#">
                                            Notification

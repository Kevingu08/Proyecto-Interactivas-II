...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <nav className={`${isOpen ? 'translate-x-0' : 'translate-x-[-50rem]'} top-0  z-50 xl:translate-x-0 bg-gradient-light fixed h-screen rounded-r-xl flex flex-col justify-between items-center transition-all duration-200`}>
                ...
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="grid mb-6 gap-2 items-center text-center mt-4">
                        ...
                        <a className="m-auto" href="#">
                            <svg
                                className="w-[24px] h-[24px] text-gray-800 dark:text-black"
                                aria-hidden="true"
                    ...
                    <ul className="flex flex-col m-auto text-start">
                        ...
                        <li>
                            ...
                            >
                                <svg
                                    className="w-[24px] h-[24px] text-gray-800 dark:text-black rotate-180"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"

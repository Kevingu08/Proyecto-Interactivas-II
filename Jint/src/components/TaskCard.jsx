   ...
   <div className="flex mb-6 h-32 bg-white rounded-lg shadow-lg">
       ...
       <div className='flex  w-full p-4'>
          <div className="max-h-32 overflow-hidden">
             ...
             <p>Description of the event Description of the event Description of the event Description of the event  Description of the event Description of the event</p>
          </div>
          <div className='grid'>
